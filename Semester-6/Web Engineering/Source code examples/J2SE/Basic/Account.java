...
public static void main(String args[])
	{
		...
		System.out.println ("Current balance after deposit the amount" + my_account.getbalance());
		...
		System.out.println ("Remaining balance after withdrawing the amount" + my_account.getbalance());
	}
