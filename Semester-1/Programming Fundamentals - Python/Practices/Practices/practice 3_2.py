# Task 01: Input ninth class marks and print result card. The 
# sample is given, ignore lines, and just show values in columns:
...
gc_merit=float(input('Enter last merit of GC in percentage:'))
...
#Task 02: Extend task 01, input last merit of GC College. Calculate & Print how many marks required in tenth 
# class to secure admission in GC College.

total_required=(gc_merit*1100)/100
required_in_tenth=int(total_required-obtained_marks)
print (f'Marks required in tenth are {required_in_tenth} out of 550')
